...
function SignInButton({loggedin, handleLogoutClick, handleSigninPopupClick, isMobileNavOpen,isNewsPage}) {
    ...
    return (
        ...
        { !loggedin ? 
            ...
            style={{width:'fit-content', color: isNewsPage ? 'black' : null, borderColor: isNewsPage ? 'black' : null}} 
            >
                <div className='button__signin-container'>
                    Name <img className='button__signin-img' src={isNewsPage ? LogoutIconBlack : LogoutIcon} alt='Logout' /> 
                </div> 
            </button>}   
        </>
    )
